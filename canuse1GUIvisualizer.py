...
class PickleWidget:
    def __init__(self, viz):
        ...
        self.load(r'C:\Users\project\stylegan3\stylegan3-r-ffhqu-256x256.pkl', ignore_errors=True)
...
def main(
    ...
    # else:
    #     pretrained = [
    #         r'C:\Users\project\stylegan3\stylegan3-r-afhqv2-512x512.pkl',
    #         r'C:\Users\project\stylegan3\stylegan3-r-ffhq-1024x1024.pkl',
    #         r'C:\Users\project\stylegan3\stylegan3-r-ffhqu-256x256.pkl',
    #     ]
    #
